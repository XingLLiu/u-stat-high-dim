...
do
    ...
    experiments/ksd_all.py --model=bimodal --k=1 --dim=50 --T=10 --n=$n --ratio_t=0.5 --ratio_s=1. --delta=6 \
    --nrep=100 --rand_start=10. & #--mcmckernel=barker 
done
# wait
# # n level test
...
#     experiments/ksd_all.py --model=bimodal --k=1 --dim=1 --T=10 --n=1000 --ratio_t=0.5 --ratio_s=1. --delta=$delta \
#     --nrep=100 --rand_start=10. & #--mcmckernel=barker
# done
wait